...
enum opt_code
{
  ...
  OPT_fbuiltin = 555,                        /* -fbuiltin */
  OPT_fbuiltin_ = 556,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 557,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 558,                   /* -fc-prototypes */
  OPT_fcall_saved_ = 559,                    /* -fcall-saved- */
  OPT_fcall_used_ = 560,                     /* -fcall-used- */
  OPT_fcaller_saves = 561,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 562,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 563, */            /* -fcf-protection */
  OPT_fcf_protection_ = 564,                 /* -fcf-protection= */
  OPT_fchar8_t = 565,                        /* -fchar8_t */
  ...
  OPT_fdce = 620,                            /* -fdce */
  OPT_fdebug = 621,                          /* -fdebug */
  OPT_fdebug_cpp = 622,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 623,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 624,            /* -fdebug-types-section */
  OPT_fdebug_ = 625,                         /* -fdebug= */
  OPT_fdec = 626,                            /* -fdec */
  OPT_fdec_include = 627,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 628,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 629,                       /* -fdec-math */
  OPT_fdec_static = 630,                     /* -fdec-static */
  OPT_fdec_structure = 631,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 632,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 633,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 634,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 635, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 636,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 637,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 638,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 639,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 640,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 641,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 642,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 643,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 644,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 645,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 646,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 647, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 648,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 649,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 650,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 651,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 652,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 653,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 654,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 655,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 656,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 657,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 658, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 659,                /* -fdirectives-only */
  OPT_fdisable_ = 660,                       /* -fdisable- */
  OPT_fdoc = 661,                            /* -fdoc */
  OPT_fdoc_dir_ = 662,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 663,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 664,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 665,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 666,         /* -fdollars-in-identifiers */
  OPT_fdse = 667,                            /* -fdse */
  OPT_fdump_ = 668,                          /* -fdump- */
  OPT_fdump_ada_spec = 669,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 670,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 671, */                /* -fdump-core */
  OPT_fdump_d_original = 672,                /* -fdump-d-original */
  OPT_fdump_final_insns = 673,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 674,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 675,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 676,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 677,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 678,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 679,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 680, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 681,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 682,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 683,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 684,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 685,                 /* -fearly-inlining */
  OPT_felide_constructors = 686,             /* -felide-constructors */
  OPT_felide_type = 687,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 688, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 689, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 690,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 691,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 692,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 693,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 694,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 695,                        /* -fenable- */
  OPT_fenforce_eh_specs = 696,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 697,                 /* -fenum-int-equiv */
  OPT_fexceptions = 698,                     /* -fexceptions */
  OPT_fexcess_precision_ = 699,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 700,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 701,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 702,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 703,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 704,                /* -fextern-tls-init */
  OPT_fexternal_blas = 705,                  /* -fexternal-blas */
  OPT_fexternal_templates = 706,             /* -fexternal-templates */
  OPT_ff2c = 707,                            /* -ff2c */
  OPT_ffast_math = 708,                      /* -ffast-math */
  OPT_ffat_lto_objects = 709,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 710,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 711,               /* -ffinite-math-only */
  OPT_ffixed_ = 712,                         /* -ffixed- */
  OPT_ffixed_form = 713,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 714,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 715,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 716,                    /* -ffloat-store */
  OPT_ffor_scope = 717,                      /* -ffor-scope */
  /* OPT_fforce_addr = 718, */               /* -fforce-addr */
  OPT_fforward_propagate = 719,              /* -fforward-propagate */
  OPT_ffp_contract_ = 720,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 721,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 722,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 723,                      /* -ffpe-trap= */
  OPT_ffree_form = 724,                      /* -ffree-form */
  OPT_ffree_line_length_ = 725,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 726,          /* -ffree-line-length-none */
  OPT_ffreestanding = 727,                   /* -ffreestanding */
  OPT_ffriend_injection = 728,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 729,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 730,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 731,                   /* -ffunction-cse */
  OPT_ffunction_sections = 732,              /* -ffunction-sections */
  OPT_fgcse = 733,                           /* -fgcse */
  OPT_fgcse_after_reload = 734,              /* -fgcse-after-reload */
  OPT_fgcse_las = 735,                       /* -fgcse-las */
  OPT_fgcse_lm = 736,                        /* -fgcse-lm */
  OPT_fgcse_sm = 737,                        /* -fgcse-sm */
  OPT_fgimple = 738,                         /* -fgimple */
  OPT_fgnat_encodings_ = 739,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 740,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 741,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 742,                         /* -fgnu-tm */
  OPT_fgnu_unique = 743,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 744,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 745,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 746,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 747,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 748,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 749,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 750,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 751,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 752,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 753,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 754,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 755,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 756,                       /* -fgraphite */
  OPT_fgraphite_identity = 757,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 758,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 759,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 760, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 761, */                     /* -fhelp */
  /* OPT_fhelp_ = 762, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 763,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 764,                      /* -fhonor-std */
  OPT_fhosted = 765,                         /* -fhosted */
  OPT_fhuge_objects = 766,                   /* -fhuge-objects */
  OPT_fident = 767,                          /* -fident */
  OPT_fif_conversion = 768,                  /* -fif-conversion */
  OPT_fif_conversion2 = 769,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 770,         /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 771,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 772,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 773,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 774,             /* -fimplicit-templates */
  OPT_findirect_inlining = 775,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 776,         /* -finhibit-size-directive */
  OPT_finit_character_ = 777,                /* -finit-character= */
  OPT_finit_derived = 778,                   /* -finit-derived */
  OPT_finit_integer_ = 779,                  /* -finit-integer= */
  OPT_finit_local_zero = 780,                /* -finit-local-zero */
  OPT_finit_logical_ = 781,                  /* -finit-logical= */
  OPT_finit_real_ = 782,                     /* -finit-real= */
  OPT_finline = 783,                         /* -finline */
  OPT_finline_atomics = 784,                 /* -finline-atomics */
  OPT_finline_functions = 785,               /* -finline-functions */
  OPT_finline_functions_called_once = 786,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 787, */            /* -finline-limit- */
  OPT_finline_limit_ = 788,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 789,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 790,         /* -finline-small-functions */
  OPT_finput_charset_ = 791,                 /* -finput-charset= */
  OPT_finstrument_functions = 792,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 793,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 794,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 795,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 796,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 797,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 798,                     /* -finvariants */
  OPT_fipa_bit_cp = 799,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 800,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 801, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 802,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 803,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 804,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 805,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 806, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 807,                    /* -fipa-profile */
  OPT_fipa_pta = 808,                        /* -fipa-pta */
  OPT_fipa_pure_const = 809,                 /* -fipa-pure-const */
  OPT_fipa_ra = 810,                         /* -fipa-ra */
  OPT_fipa_reference = 811,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 812,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 813,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 814,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 815, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 816,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 817,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 818,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 819,              /* -fira-loop-pressure */
  OPT_fira_region_ = 820,                    /* -fira-region= */
  OPT_fira_share_save_slots = 821,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 822,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 823,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 824,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 825,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 826,               /* -fivar-visibility= */
  OPT_fivopts = 827,                         /* -fivopts */
  OPT_fjump_tables = 828,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 829,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 830,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 831,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 832,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 833,          /* -fkeep-static-functions */
  OPT_flabels_ok = 834,                      /* -flabels-ok */
  OPT_flax_vector_conversions = 835,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 836,             /* -fleading-underscore */
  OPT_flifetime_dse = 837,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 838,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 839,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 840,                 /* -flinker-output= */
  /* OPT_flive_patching = 841, */            /* -flive-patching */
  OPT_flive_patching_ = 842,                 /* -flive-patching= */
  OPT_flive_range_shrinkage = 843,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 844,                    /* -flocal-ivars */
  /* OPT_floop_block = 845, */               /* -floop-block */
  /* OPT_floop_flatten = 846, */             /* -floop-flatten */
  OPT_floop_interchange = 847,               /* -floop-interchange */
  OPT_floop_nest_optimize = 848,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 849, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 850,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 851, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 852,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 853,                      /* -flra-remat */
  OPT_flto = 854,                            /* -flto */
  OPT_flto_compression_level_ = 855,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 856,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 857,                 /* -flto-partition= */
  OPT_flto_report = 858,                     /* -flto-report */
  OPT_flto_report_wpa = 859,                 /* -flto-report-wpa */
  OPT_flto_ = 860,                           /* -flto= */
  OPT_fltrans = 861,                         /* -fltrans */
  OPT_fltrans_output_list_ = 862,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 863,              /* -fmacro-prefix-map= */
  OPT_fmain = 864,                           /* -fmain */
  OPT_fmath_errno = 865,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 866,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 867,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 868,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 869,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 870,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 871,                     /* -fmem-report */
  OPT_fmem_report_wpa = 872,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 873,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 874,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 875,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 876,                /* -fmessage-length= */
  OPT_fmodule_file_ = 877,                   /* -fmodule-file= */
  OPT_fmodule_private = 878,                 /* -fmodule-private */
  OPT_fmoduleinfo = 879,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 880,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 881,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 882,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 883,                  /* -fms-extensions */
  OPT_fmudflap = 884,                        /* -fmudflap */
  OPT_fmudflapir = 885,                      /* -fmudflapir */
  OPT_fmudflapth = 886,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 887,         /* -fname-mangling-version- */
  OPT_fnew_abi = 888,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 889,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 890,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 891,                   /* -fnext-runtime */
  OPT_fnil_receivers = 892,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 893,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 894,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 895,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 896,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 897,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 898,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 899,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 900,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 901,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 902,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 903,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 904,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 905,                   /* -foffload-abi= */
  OPT_foffload_ = 906,                       /* -foffload= */
  OPT_fomit_frame_pointer = 907,             /* -fomit-frame-pointer */
  OPT_fonly_ = 908,                          /* -fonly= */
  OPT_fopenacc = 909,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 910,                   /* -fopenacc-dim= */
  OPT_fopenmp = 911,                         /* -fopenmp */
  OPT_fopenmp_simd = 912,                    /* -fopenmp-simd */
  OPT_foperator_names = 913,                 /* -foperator-names */
  OPT_fopt_info = 914,                       /* -fopt-info */
  OPT_fopt_info_ = 915,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 916, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 917,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 918,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 919, */           /* -foptional-diags */
  OPT_fpack_derived = 920,                   /* -fpack-derived */
  OPT_fpack_struct = 921,                    /* -fpack-struct */
  OPT_fpack_struct_ = 922,                   /* -fpack-struct= */
  OPT_fpad_source = 923,                     /* -fpad-source */
  OPT_fpartial_inlining = 924,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 925,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 926,              /* -fpcc-struct-return */
  OPT_fpch_deps = 927,                       /* -fpch-deps */
  OPT_fpch_preprocess = 928,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 929,                     /* -fpeel-loops */
  OPT_fpeephole = 930,                       /* -fpeephole */
  OPT_fpeephole2 = 931,                      /* -fpeephole2 */
  OPT_fpermissive = 932,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 933,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 934,                            /* -fpic */
  OPT_fpie = 935,                            /* -fpie */
  OPT_fplan9_extensions = 936,               /* -fplan9-extensions */
  OPT_fplt = 937,                            /* -fplt */
  OPT_fplugin_arg_ = 938,                    /* -fplugin-arg- */
  OPT_fplugin_ = 939,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 940,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 941,                 /* -fpostconditions */
  OPT_fpre_include_ = 942,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 943,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 944,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 945,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 946,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 947,                   /* -fpreprocessed */
  OPT_fpretty_templates = 948,               /* -fpretty-templates */
  OPT_fprintf_return_value = 949,            /* -fprintf-return-value */
  OPT_fprofile = 950,                        /* -fprofile */
  OPT_fprofile_abs_path = 951,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 952,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 953,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 954,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 955,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 956,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 957,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 958,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 959,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 960,                 /* -fprofile-report */
  OPT_fprofile_update_ = 961,                /* -fprofile-update= */
  OPT_fprofile_use = 962,                    /* -fprofile-use */
  OPT_fprofile_use_ = 963,                   /* -fprofile-use= */
  OPT_fprofile_values = 964,                 /* -fprofile-values */
  OPT_fprotect_parens = 965,                 /* -fprotect-parens */
  OPT_frandom_seed = 966,                    /* -frandom-seed */
  OPT_frandom_seed_ = 967,                   /* -frandom-seed= */
  OPT_frange_check = 968,                    /* -frange-check */
  OPT_freal_4_real_10 = 969,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 970,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 971,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 972,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 973,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 974,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 975,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 976,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 977,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 978,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 979,                /* -frecord-marker=8 */
  OPT_frecursive = 980,                      /* -frecursive */
  OPT_free = 981,                            /* -free */
  OPT_freg_struct_return = 982,              /* -freg-struct-return */
  /* OPT_fregmove = 983, */                  /* -fregmove */
  OPT_frelease = 984,                        /* -frelease */
  OPT_frename_registers = 985,               /* -frename-registers */
  OPT_freorder_blocks = 986,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 987,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 988,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 989,              /* -freorder-functions */
  OPT_frepack_arrays = 990,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 991,           /* -freplace-objc-classes */
  OPT_frepo = 992,                           /* -frepo */
  OPT_freport_bug = 993,                     /* -freport-bug */
  OPT_frequire_return_statement = 994,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 995,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 996, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 997,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 998,                    /* -fresolution= */
  OPT_frounding_math = 999,                  /* -frounding-math */
  OPT_frtti = 1000,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1001,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1002,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1003,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1004,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1005,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1006,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1007,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1008,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1009, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1010,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1011,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1012,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1013,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1014,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1015,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1016,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1017,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1018,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1019,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1020,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1021,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1022,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1023,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1024,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1025,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1026, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1027,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1028,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1029,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1030,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1031,               /* -fsection-anchors */
  /* OPT_fsee = 1032, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1033,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1034,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1035,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1036,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1037,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1038,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1039,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1040,                   /* -fshort-enums */
  OPT_fshort_wchar = 1041,                   /* -fshort-wchar */
  OPT_fshow_column = 1042,                   /* -fshow-column */
  OPT_fshrink_wrap = 1043,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1044,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1045,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1046,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1047,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1048,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1049,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1050,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1051,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1052,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1053,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1054,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1055,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1056,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1057,              /* -fsplit-wide-types */
  OPT_fsquangle = 1058,                      /* -fsquangle */
  OPT_fssa_backprop = 1059,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1060,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1061,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1062,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1063, */             /* -fstack-check */
  OPT_fstack_check_ = 1064,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1065,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1066,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1067,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1068,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1069,               /* -fstack-protector */
  OPT_fstack_protector_all = 1070,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1071,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1072,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1073,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1074,                   /* -fstack-usage */
  OPT_fstats = 1075,                         /* -fstats */
  OPT_fstdarg_opt = 1076,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1077,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1078, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1079,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1080,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1081,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1082,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1083,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1084, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1085,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1086,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1087,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1088,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1089,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1090, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1091,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1092, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1093,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1094,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1095,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1096,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1097,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1098,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1099,                   /* -ftime-report */
  OPT_ftime_report_details = 1100,           /* -ftime-report-details */
  OPT_ftls_model_ = 1101,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1102,              /* -ftoplevel-reorder */
  OPT_ftracer = 1103,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1104,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1105,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1106,                   /* -ftrampolines */
  OPT_ftransition_all = 1107,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1108,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1109,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1110,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1111,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1112,              /* -ftransition=field */
  OPT_ftransition_import = 1113,             /* -ftransition=import */
  OPT_ftransition_nogc = 1114,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1115,                /* -ftransition=tls */
  OPT_ftrapping_math = 1116,                 /* -ftrapping-math */
  OPT_ftrapv = 1117,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1118,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1119,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1120,                      /* -ftree-ccp */
  OPT_ftree_ch = 1121,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1122, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1123,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1124,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1125, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1126,                   /* -ftree-cselim */
  OPT_ftree_dce = 1127,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1128,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1129,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1130,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1131,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1132, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1133,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1134,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1135, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1136,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1137,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1138, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1139,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1140,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1141,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1142,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1143,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1144,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1145,                      /* -ftree-pre */
  OPT_ftree_pta = 1146,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1147,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1148, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1149,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1150,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1151,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1152,                     /* -ftree-slsr */
  OPT_ftree_sra = 1153,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1154, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1155, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1156,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1157,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1158,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1159, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1160,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1161, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1162,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1163,         /* -funconstrained-commons */
  OPT_funderscoring = 1164,                  /* -funderscoring */
  OPT_funit_at_a_time = 1165,                /* -funit-at-a-time */
  OPT_funittest = 1166,                      /* -funittest */
  OPT_funroll_all_loops = 1167,              /* -funroll-all-loops */
  OPT_funroll_loops = 1168,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1169, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1170,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1171,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1172,                 /* -funsigned-char */
  OPT_funswitch_loops = 1173,                /* -funswitch-loops */
  OPT_funwind_tables = 1174,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1175,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1176,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1177,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1178,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1179,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1180,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1181,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1182,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1183,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1184,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1185,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1186, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1187,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1188,                   /* -fverbose-asm */
  /* OPT_fversion = 1189, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1190,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1191,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1192,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1193,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1194,                   /* -fvisibility= */
  OPT_fvpt = 1195,                           /* -fvpt */
  OPT_fvtable_gc = 1196,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1197,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1198,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1199,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1200,                     /* -fvtv-debug */
  OPT_fweak = 1201,                          /* -fweak */
  OPT_fweb = 1202,                           /* -fweb */
  /* OPT_fwhole_file = 1203, */              /* -fwhole-file */
  OPT_fwhole_program = 1204,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1205,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1206,             /* -fworking-directory */
  OPT_fwpa = 1207,                           /* -fwpa */
  OPT_fwpa_ = 1208,                          /* -fwpa= */
  OPT_fwrapv = 1209,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1210,                 /* -fwrapv-pointer */
  OPT_fxref = 1211,                          /* -fxref */
  /* OPT_fzee = 1212, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1213,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1214,                     /* -fzero-link */
  OPT_g = 1215,                              /* -g */
  OPT_gant = 1216,                           /* -gant */
  OPT_gas_loc_support = 1217,                /* -gas-loc-support */
  OPT_gas_locview_support = 1218,            /* -gas-locview-support */
  OPT_gcoff = 1219,                          /* -gcoff */
  OPT_gcoff1 = 1220,                         /* -gcoff1 */
  OPT_gcoff2 = 1221,                         /* -gcoff2 */
  OPT_gcoff3 = 1222,                         /* -gcoff3 */
  OPT_gcolumn_info = 1223,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1224,                 /* -gdescribe-dies */
  OPT_gdwarf = 1225,                         /* -gdwarf */
  OPT_gdwarf_ = 1226,                        /* -gdwarf- */
  OPT_gen_decls = 1227,                      /* -gen-decls */
  OPT_ggdb = 1228,                           /* -ggdb */
  OPT_ggnu_pubnames = 1229,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1230,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1231, /* -ginternal-reset-location-views */
  OPT_gnat = 1232,                           /* -gnat */
  OPT_gnatO = 1233,                          /* -gnatO */
  OPT_gno_ = 1234,                           /* -gno- */
  OPT_gno_pubnames = 1235,                   /* -gno-pubnames */
  OPT_gpubnames = 1236,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1237,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1238,                   /* -gsplit-dwarf */
  OPT_gstabs = 1239,                         /* -gstabs */
  OPT_gstabs_ = 1240,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1241,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1242,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1243,                        /* -gtoggle */
  OPT_gvariable_location_views = 1244,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1245,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1246,                           /* -gvms */
  OPT_gxcoff = 1247,                         /* -gxcoff */
  OPT_gxcoff_ = 1248,                        /* -gxcoff+ */
  OPT_gz = 1249,                             /* -gz */
  OPT_gz_ = 1250,                            /* -gz= */
  OPT_h = 1251,                              /* -h */
  OPT_idirafter = 1252,                      /* -idirafter */
  OPT_imacros = 1253,                        /* -imacros */
  OPT_imultiarch = 1254,                     /* -imultiarch */
  OPT_imultilib = 1255,                      /* -imultilib */
  OPT_include = 1256,                        /* -include */
  OPT_iplugindir_ = 1257,                    /* -iplugindir= */
  OPT_iprefix = 1258,                        /* -iprefix */
  OPT_iquote = 1259,                         /* -iquote */
  OPT_isysroot = 1260,                       /* -isysroot */
  OPT_isystem = 1261,                        /* -isystem */
  OPT_iwithprefix = 1262,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1263,              /* -iwithprefixbefore */
  OPT_k8 = 1264,                             /* -k8 */
  OPT_l = 1265,                              /* -l */
  OPT_lang_asm = 1266,                       /* -lang-asm */
  OPT_mabi_ = 1267,                          /* -mabi= */
  OPT_march_ = 1268,                         /* -march= */
  OPT_mbig_endian = 1269,                    /* -mbig-endian */
  OPT_mbionic = 1270,                        /* -mbionic */
  OPT_mbranch_protection_ = 1271,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1272,                       /* -mcmodel= */
  OPT_mcpu_ = 1273,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1274,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1275,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1276,             /* -mgeneral-regs-only */
  OPT_mglibc = 1277,                         /* -mglibc */
  OPT_mlittle_endian = 1278,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1279,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1280,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1281,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1282,                          /* -mmusl */
  ...
  OPT_mverbose_cost_dump = 1297,             /* -mverbose-cost-dump */
  OPT_n = 1298,                              /* -n */
  OPT_no_canonical_prefixes = 1299,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1300,              /* -no-integrated-cpp */
  OPT_no_pie = 1301,                         /* -no-pie */
  OPT_nocpp = 1302,                          /* -nocpp */
  OPT_nodefaultlibs = 1303,                  /* -nodefaultlibs */
  OPT_nolibc = 1304,                         /* -nolibc */
  OPT_nophoboslib = 1305,                    /* -nophoboslib */
  ...
  OPT_s = 1336,                              /* -s */
  OPT_save_temps = 1337,                     /* -save-temps */
  OPT_save_temps_ = 1338,                    /* -save-temps= */
  OPT_shared = 1339,                         /* -shared */
  OPT_shared_libgcc = 1340,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1341,               /* -shared-libphobos */
  ...
  OPT_static_libgfortran = 1347,             /* -static-libgfortran */
  OPT_static_libgo = 1348,                   /* -static-libgo */
  OPT_static_liblsan = 1349,                 /* -static-liblsan */
  OPT_static_libmpx = 1350,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1351,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1352,               /* -static-libphobos */
  OPT_static_libstdc__ = 1353,               /* -static-libstdc++ */
  OPT_static_libtsan = 1354,                 /* -static-libtsan */
  OPT_static_libubsan = 1355,                /* -static-libubsan */
  OPT_static_pie = 1356,                     /* -static-pie */
  /* OPT_std_c__03 = 1357, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1358, */                /* -std=c++0x */
  OPT_std_c__11 = 1359,                      /* -std=c++11 */
  OPT_std_c__14 = 1360,                      /* -std=c++14 */
  OPT_std_c__17 = 1361,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1362, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1363, */                /* -std=c++1z */
  OPT_std_c__2a = 1364,                      /* -std=c++2a */
  OPT_std_c__98 = 1365,                      /* -std=c++98 */
  OPT_std_c11 = 1366,                        /* -std=c11 */
  OPT_std_c17 = 1367,                        /* -std=c17 */
  /* OPT_std_c18 = 1368, */                  /* -std=c18 */
  /* OPT_std_c1x = 1369, */                  /* -std=c1x */
  OPT_std_c2x = 1370,                        /* -std=c2x */
  /* OPT_std_c89 = 1371, */                  /* -std=c89 */
  OPT_std_c90 = 1372,                        /* -std=c90 */
  OPT_std_c99 = 1373,                        /* -std=c99 */
  /* OPT_std_c9x = 1374, */                  /* -std=c9x */
  OPT_std_f2003 = 1375,                      /* -std=f2003 */
  OPT_std_f2008 = 1376,                      /* -std=f2008 */
  OPT_std_f2008ts = 1377,                    /* -std=f2008ts */
  OPT_std_f2018 = 1378,                      /* -std=f2018 */
  OPT_std_f95 = 1379,                        /* -std=f95 */
  OPT_std_gnu = 1380,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1381, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1382, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1383,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1384,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1385,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1386, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1387, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1388,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1389,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1390,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1391,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1392, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1393, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1394,                      /* -std=gnu2x */
  ...
  /* OPT_std_iso9899_2017 = 1404, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1405, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1406,                     /* -std=legacy */
  OPT_symbolic = 1407,                       /* -symbolic */
  OPT_t = 1408,                              /* -t */
  OPT_time = 1409,                           /* -time */
  OPT_time_ = 1410,                          /* -time= */
  OPT_traditional = 1411,                    /* -traditional */
  OPT_traditional_cpp = 1412,                /* -traditional-cpp */
  OPT_trigraphs = 1413,                      /* -trigraphs */
  OPT_u = 1414,                              /* -u */
  OPT_undef = 1415,                          /* -undef */
  OPT_v = 1416,                              /* -v */
  OPT_version = 1417,                        /* -version */
  OPT_w = 1418,                              /* -w */
  OPT_wrapper = 1419,                        /* -wrapper */
  OPT_x = 1420,                              /* -x */
  OPT_z = 1421,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
